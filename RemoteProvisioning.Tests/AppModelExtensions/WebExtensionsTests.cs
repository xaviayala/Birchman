...
using Birchman.RemoteProvisioning.Tests;
using System.IO;
...
namespace Microsoft.SharePoint.Client.Tests
{
    ...
    public class WebExtensionsTests
    {
        ...
        public void GetAppInstancesTest()
        {
            ...
            #if !CLIENTSDKV15
            byte[] appToLoad = Birchman.RemoteProvisioning.Tests.Properties.Resources.HelloWorldApp;
            #else
            byte[] appToLoad = Birchman.RemoteProvisioning.Tests.Properties.Resources.HelloWorldApp15;
            #endif
        ...
        public void InstallSolutionTest()
        {
            using (var clientContext = TestCommon.CreateClientContext())
            {
                ...
                System.IO.File.WriteAllBytes(solutionpath, Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolution);

                clientContext.Site.InstallSolution(new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionGuid), solutionpath);
      ...
      @"<View>  
            <Query> 
             ...
             <ViewFields><FieldRef Name='ID' /></ViewFields> 
      </View>", new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionGuid));
              ...
              //  clientContext.Web.ActivateFeature(new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionFeatureGuid));
              //  Assert.IsTrue(clientContext.Web.IsFeatureActive(new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionFeatureGuid)), "Test feature not activated");
             
                // Teardown
                // Done using the local file, remove it
                System.IO.File.Delete(solutionpath);
                clientContext.Site.UninstallSolution(new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionGuid),"testsolution.wsp");
            }
        }
  ...
  @"<View>  
            ...
            Assert.IsFalse(clientContext.Web.IsFeatureActive(new Guid(Birchman.RemoteProvisioning.Tests.Properties.Resources.TestSolutionFeatureGuid)));
