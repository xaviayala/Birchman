...
namespace Microsoft.SharePoint.Client.Helper
{
	public class FieldAndContentTypeExtensionsTests
	{
        ...
        public void AddContentTypeToListByName(ClientContext clientContext)
        {
            clientContext.Web.AddContentTypeToListByName(listName, "Issue", defaultContent: true);
            clientContext.ExecuteQuery();
        }

        public void RemoveContentTypeFromListByName(ClientContext clientContext)
        {
