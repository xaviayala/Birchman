...
namespace Birchman.RemoteProvisioning.Data.Enums
{
    public static class BuiltInFieldId
    {
        ...
        public static bool Contains(Guid fid)
        {
            if (s_dict == null)
            {
                s_dict = new Dictionary<Guid, bool>(440);
                s_dict[DisplayTemplateJSTargetListTemplate] = true;
                s_dict[Editor] = true;
                s_dict[WebPage] = true;
                ...
                s_dict[User] = true;
                s_dict[RelatedItems] = true;
                s_dict[URL] = true;
                s_dict[Detail] = true;
                s_dict[RecurrenceID] = true;
                s_dict[AppAuthor] = true;
                s_dict[HealthRuleSchedule] = true;
                s_dict[ParentItemEditor] = true;
                ...
                s_dict[DisplayTemplateJSIconUrl] = true;
                s_dict[End] = true;
                s_dict[EncodedAbsThumbnailUrl] = true;
                s_dict[Description] = true;
                s_dict[DisplayTemplateJSTargetContentType] = true;
                ...
                s_dict[DisplayTemplateJSConfigurationUrl] = true;
                s_dict[_ModerationStatus] = true;
                s_dict[DisplayTemplateJSTargetScope] = true;
                s_dict[ParentItemID] = true;
                ...
                s_dict[PrincipalCount] = true;
                s_dict[ParentLeafName] = true;
                s_dict[DisplayTemplateJSTargetControlType] = true;
                ...
                s_dict[wic_System_Copyright] = true;
                ...
                s_dict[RelatedLinks] = true;
                s_dict[Birthday] = true;
                s_dict[DiscussionLastUpdated] = true;
                s_dict[DisplayTemplateJSTemplateHidden] = true;
                ...
                s_dict[DisplayTemplateJSTemplateType] = true;
