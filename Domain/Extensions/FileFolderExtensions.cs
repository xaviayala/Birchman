...
using Birchman.RemoteProvisioning.Domain;
...
namespace Microsoft.SharePoint.Client
{
    public static partial class FileFolderExtensions
    {
        ...
        public static Microsoft.SharePoint.Client.File UploadFile(this Folder folder, string fileName, string localFilePath, bool overwriteIfExists)
        {
            if (folder == null)
            {
        ...
        /// <param name="overwriteIfExists">true (default) to overwite existing files</param>
        /// <returns>The uploaded File, so that additional operations (such as setting properties) can be done.</returns>
        public static Microsoft.SharePoint.Client.File UploadFileWebDav(this Folder folder, string fileName, string localFilePath, bool overwriteIfExists)
        {
            if (folder == null)
            {
                throw new ArgumentNullException("folder");
        ...
        /// <param name="overwriteIfExists">true (default) to overwite existing files</param>
        /// <returns>The uploaded File, so that additional operations (such as setting properties) can be done.</returns>
        public static Microsoft.SharePoint.Client.File UploadFileWebDav(this Folder folder, string fileName, Stream stream, bool overwriteIfExists)
        {
            if (fileName == null)
            {
                throw new ArgumentNullException("fileName");
        ...
        public static Microsoft.SharePoint.Client.File GetFile(this Folder folder, string fileName)
        {
            if (folder == null)
            {
                throw new ArgumentNullException("folder");
        ...
        public static bool VerifyIfUploadRequired(this Microsoft.SharePoint.Client.File serverFile, string localFile)
        {
            if (localFile == null)
            {
        ...
        /// <returns></returns>
        public static bool VerifyIfUploadRequired(this Microsoft.SharePoint.Client.File serverFile, Stream localStream)
        {
            if (serverFile == null)
            {
        ...
        public static void SetFileProperties(this Microsoft.SharePoint.Client.File file, IDictionary<string, string> properties, bool checkoutIfRequired = true)
        {
            if (file == null)
            {
        ...
        public static void PublishFileToLevel(this Microsoft.SharePoint.Client.File file, FileLevel level)
        {
            if (file == null)
            {
                throw new ArgumentNullException("file");
