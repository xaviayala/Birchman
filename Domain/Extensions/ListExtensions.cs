...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class ListExtensions
    {
        ...
        /// <summary>
        /// Get list by using Title 
        /// Attention! #TODO: [You can] Comment this method when Upgrade to March 2015 i.e. GetList() method becomes available! 
        /// </summary>
        /// <param name="web">Site to be processed - can be root web or sub site</param>
        /// <param name="webRelativeUrl">Url of the list to return</param>
        /// <returns>Loaded list instance matching to title or null</returns>
        /// <exception cref="System.ArgumentException">Thrown when listTitle is a zero-length string or contains only white space</exception>
        /// <exception cref="System.ArgumentNullException">listTitle is null</exception>
        public static List GetListByUrl(this Web web, string webRelativeUrl)
        {
            ...
            {
                throw (webRelativeUrl == null)
                  ? new ArgumentNullException("webRelativeUrl")
                  : new ArgumentException(CoreResources.Exception_Message_EmptyString_Arg, "webRelativeUrl");
            }
            ListCollection lists = web.Lists;
            IEnumerable<List> results = web.Context.LoadQuery<List>(lists.Where(list => list.DefaultViewUrl.IndexOf(webRelativeUrl) > 0));
            web.Context.ExecuteQuery();
            return results.FirstOrDefault();
        }
        ...
        /// <returns></returns>
        /// #TODO: Upgrade to March 2015 so GetList() method becomes available! 
        //public static List GetListByUrl(this Web web, string webRelativeUrl)
        //{
        //    if (string.IsNullOrEmpty(webRelativeUrl))
