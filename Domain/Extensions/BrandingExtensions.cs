...
namespace Microsoft.SharePoint.Client
{
    ...
    public static partial class BrandingExtensions
    {
        ...
        /// <param name="themeFolderVersion">Leaf folder name to upload to; default is "15"</param>
        /// <returns>The uploaded file, with at least the ServerRelativeUrl property available</returns>
        public static Microsoft.SharePoint.Client.File UploadThemeFile(this Web web, string fileName, string localFilePath, string themeFolderVersion = "15")
        {
        ...
        /// <param name="themeFolderVersion">Leaf folder name to upload to; default is "15"</param>
        /// <returns>The uploaded file, with at least the ServerRelativeUrl property available</returns>
        public static Microsoft.SharePoint.Client.File UploadThemeFile(this Web web, string fileName, Stream localStream, string themeFolderVersion = "15")
        {
            if (fileName == null) { throw new ArgumentNullException("fileName"); }
